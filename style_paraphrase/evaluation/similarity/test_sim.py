...
model = torch.load('/home/chiyu94/scratch/hashtag_paraphrase/evaluation/sim/sim.pt')
...
sp.Load('/home/chiyu94/scratch/hashtag_paraphrase/evaluation/sim/sim.sp.30k.model')
model.eval()
